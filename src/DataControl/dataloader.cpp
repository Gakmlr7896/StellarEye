...
int main() {
    freopen("results/outputs/output.txt", "w", stdout);
    freopen("results/outputs/errors.txt", "w", stderr);
    ...
    fits_open_file(&fptr, "Data/SDSS/spAll-v6_1_3.fits.gz", READONLY, &status);
    ...
    std::cout << "=== FITS File Info ===" << std::endl;
